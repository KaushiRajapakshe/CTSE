                  ...
                  Container(
                      child: Stack(
                          children: <Widget>[
                            ...
                            Container(
                              padding: EdgeInsets.fromLTRB(20.0, 160.0, 20.0, 20.0),
                              child: Text(
                            ...
                            Container(
                              padding: EdgeInsets.fromLTRB(20.0, 235.0, 20.0, 20.0),
                              child: Text(
                            ...
                            Container(
                              padding: EdgeInsets.fromLTRB(20.0, 300.0, 20.0, 20.0),
                              child: Text(
...
//                        fontFamily: 'ArchivoBlack',
                            ...
                            Container(
                              ...
                              padding: EdgeInsets.fromLTRB(100.0, 570.0, 0.0, 0.0),
                              child: Text(
                                'You are logged in Google ',
                                style: TextStyle(
                                  fontSize: 16.0,fontWeight: FontWeight.bold,color: Color(0xFFFAFAFA),
                            ...
                            const SizedBox(height:150.0),
                            Container(
                              padding: EdgeInsets.only(top: 600,left: 70,right: 70,bottom: 10),
                              child: MaterialButton(
                                onPressed: () {
                                  AuthProvider().logOut();
                                },
